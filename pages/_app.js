...
MyApp.getInitialProps = async appContext => {
	...
	let csp = `default-src 'self' guac.live *.guac.live privacy.guac.live localhost:*; base-uri 'self'; script-src 'self' ${devCsp} 'nonce-${nonce}' 'strict-dynamic' www.google.com www.googletagmanager.com www.google-analytics.com www.gstatic.com *.googleapis.com guac.live *.guac.live cheese.guac.live privacy.guac.live quantcast.mgr.consensu.org localhost:* c6.patreon.com static.cloudflareinsights.com wss://chat.guac.live wss://viewer-api.guac.live cdn.ravenjs.com; child-src www.google.com guac.live *.guac.live privacy.guac.live quantcast.mgr.consensu.org localhost:* patreon.com www.patreon.com wss://chat.guac.live wss://viewer-api.guac.live blob:; style-src 'self' 'unsafe-inline' *.googleapis.com use.fontawesome.com pro.fontawesome.com guac.live *.guac.live privacy.guac.live quantcast.mgr.consensu.org localhost:*; img-src 'self' data: guac.live *.guac.live emotes.guac.live privacy.guac.live quantcast.mgr.consensu.org cheese.guac.live chat.guac.live viewer-api.guac.live *.googleapis.com *.gstatic.com www.google-analytics.com c6.patreon.com *.giphy.com android-webview-video-poster: http: https:; media-src 'self' blob: guac.live *.guac.live privacy.guac.live quantcast.mgr.consensu.org localhost:* wss://chat.guac.live wss://viewer-api.guac.live; connect-src 'self' guac.live *.guac.live emotes.guac.live privacy.guac.live quantcast.mgr.consensu.org nttpf0l7a8eq71c8oqmhd5r3a.litix.io *.quantcast.mgr.consensu.org firebaseinstallations.googleapis.com fcmregistrations.googleapis.com localhost:* sdk.split.io events.split.io c6.patreon.com ws://chat.local.guac.live ws://viewer-api.guac.live ws://chat.guac.live wss://guac.live wss://chat.guac.live wss://viewer-api.guac.live ws://localhost:* wss://localhost:* ws://local.guac.live wss://local.guac.live ws://stream.local.guac.live wss://stream.local.guac.live ws://stream.guac.live wss://stream.guac.live ws://*.stream.guac.live wss://*.stream.guac.live www.google-analytics.com vendorlist.consensu.org api.betterttv.net api.frankerfacez.com api-test.frankerfacez.com twitchemotes.com *.giphy.com fcm.googleapis.com https://sentry.io blob:; font-src 'self' use.fontawesome.com pro.fontawesome.com guac.live *.guac.live *.gstatic.com data:; object-src 'none'; report-uri https://o222117.ingest.sentry.io/api/1369483/security/?sentry_key=8dacf1eaf9c24bcfbc37284e60cf6f9b;`;

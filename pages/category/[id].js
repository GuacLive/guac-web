			...
			<Fragment>
				<div className="w-100 pv3 ph3-l">
					<div className="flex pa4 cover" style={{
								...
								'background': `linear-gradient(rgba(15, 15, 15, 0), rgb(21, 21, 21)), linear-gradient(rgba(21, 21, 21, 0.8), rgba(21, 21, 21, 0.5)), url(${thisCategory && thisCategory.cover ? thisCategory.cover : '/img/categories/' + category_id + '.jpg'})`,

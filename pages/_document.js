...
export default class MyDocument extends Document {
	static getInitialProps({req, renderPage}) {
		...
		let headerClass =  getCookie('site-mode', req) === 'dark' ? 'guac-skin-dark' : 'guac-skin-light';
		return { html, head, errorHtml, chunks, 'nonce': req.nonce, headerClass }
	...
	render() {
		...
		return (
		<html data-cast-api-enabled="true" className={this.props.headerClass}>
			<Head nonce={nonce}>

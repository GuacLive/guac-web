	...
	render() {
		...
		<html data-cast-api-enabled="true">
			<Head nonce={this.props.nonce}>
				...
				<script type="text/javascript" dangerouslySetInnerHTML={{__html: oil}} nonce={this.props.nonce}></script>
				<script type="text/javascript" src="//privacy.guac.live/scripts/oil.1.2.5-RELEASE.min.js" nonce={this.props.nonce}></script>
			</Head>

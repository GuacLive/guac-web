...
function AccountMenu(props){
	...
	return (
		<>
			<a className="link pv2 ph3" href="#!" onClick={() => setShow(!show)}><img alt={props.user.name} className="dim ba b--transparent db br-100 w2 w2-ns h2 h2-ns" src={props.user.name} /></a>

...
function AccountMenu(props){
	...
	return (
		<div className="items-stretch flex flex-grow-1 h-100 pl2 relative">
			<a title="Account menu" className="db link pv2 ph3 color-inherit" href="#!" onClick={() => setIsOpen(!isOpen)}>
				<div className="relative w2 w2-ns h2 h2-ns">
					<Image alt="User avatar" src={props.user && props.user.avatar || 'https://cdn.guac.live/profile-avatars/offline-avatar.png'} alt={props.user ? props.user.name : null} width={70} height={70} shape="squircle" fit="cover" lazyload className="dim" />
				</div>
			</a>
						...
						<div className="flex items-center">
							<Link href="/settings">
								<a className="link ml0 mr3 relative w2 w2-ns h2 h2-ns">
									<Image alt="User avatar" src={props.user && props.user.avatar || 'https://cdn.guac.live/profile-avatars/offline-avatar.png'} alt={props.user.name} shape="squircle" width={70} height={70} fit="cover" lazyload className="dim" />
								</a>
							</Link>
							<div>

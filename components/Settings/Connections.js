				...
				<div className="settings-row flex flex-row w-100 pa2">
					...
					<div className="flex flex-column flex-grow-1 w-100 ph3">
						<div className="items-center flex flex-row">
								...
								{auth && auth.user && auth.user.patreon ?
									<div className="pt3">
										<div className="items-center flex">
											...
											<span className="v-mid pl2">Your Patreon account is connected.</span>
											<div className="pl3">
												<div className="items-center flex">
													<span className="v-mid f6 ma0 silver">{auth.user.patreon.isPatron ? `Patreon Status: ${auth.user.patreon.tier}` : "Patreon Status: Not a Patron"}</span>
												</div>
											</div>
										</div>
									</div>
							...
							<div className="content-center v-mid inline-flex justify-center overflow-hidden relative link color-inherit nowrap lh-solid pointer br2 ba b--green bg-green">
								<span className="items-center flex flex-grow-0 pv2 ph3">Connect</span>
							</div>
						</div>
						<div className="pt4">

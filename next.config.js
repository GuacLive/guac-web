...
module.exports = withTM(withOffline({
	...
	images: {
		domains: ['guac.live', 'api.guac.live', 'media.rawg.io', 'stream.guac.live', '//api.guac.live', '//stream.guac.live', 'cdn.frankerfacez.com', 'static-cdn.jtvnw.net', 'cdn.betterttv.net']
	},
	experimental: {
		plugins: true,
		sprFlushToDisk: true,
